  ...
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'pending-tickets' ? activeClass : inactiveClass]"
          to="/admin/pending-tickets"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
          ...
          <span class="mx-4">Pending Tickets</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'resolved-tickets' ? activeClass : inactiveClass]"
        ...
        >
          ...
          <span class="mx-4">Resolved Tickets</span>
        </router-link>
      </nav>
    </div>
  </div>
